...
template.innerHTML = `
    <div class="cb-echart-boxplot" style="width:100%; height:400px; overflow: hidden;">
...
class BoxPlot extends HTMLElement {
    constructor() {
        ...
        this.data_ = [
            [850, 740, 900, 1070, 945],
            [960, 940, 960, 1040, 980],
            [960, 960, 960, 960, 960],
            [880, 880, 880, 880, 880],
            [720, 760, 810, 870, 840]
        ]; // Example data
...
customElements.define('cb-echart-boxplot', BoxPlot);
