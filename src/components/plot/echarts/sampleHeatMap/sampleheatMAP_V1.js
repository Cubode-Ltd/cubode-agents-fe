...
import { VisualMapComponent, TitleComponent, TooltipComponent, GridComponent, DatasetComponent, TransformComponent, LegendComponent, ToolboxComponent, DataZoomComponent} from "echarts/components";
import { LabelLayout, UniversalTransition } from "echarts/features";
import { CanvasRenderer } from "echarts/renderers";

echarts.use([ HeatmapChart, VisualMapComponent ,TitleComponent, TooltipComponent, GridComponent, DatasetComponent, TransformComponent, LabelLayout, UniversalTransition, CanvasRenderer, LegendComponent, ToolboxComponent, DataZoomComponent]);
...
plotData(seriesName, columnCategory, columnsValues, aggregation, colorScale, primaryColor, secondaryColor) {
    ...
    const x_category = this.df.select(columnCategory).toArray();
    const y_category = this.df.select(columnsValues).toArray();

    console.log(x_category,'<<<X_Category');

    console.log(y_category,'<<<y_Category');
