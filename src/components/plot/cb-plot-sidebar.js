...
sidebarTemplate.innerHTML = `
  ...
  <div class="sidebar-container" style="position: relative;">
    ...
    <div class="sidebar hidden fixed left-0 top-0 bg-white dark:bg-gray-600 border-2 border-gray-300 w-64 h-full p-5 flex flex-col transition-transform transform -translate-x-full">
        <button class="cb-close-sidebar-button h-12 border rounded-xl bg-gray-50 mb-5">Close</button>
