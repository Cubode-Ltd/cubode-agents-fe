...
modalTemplate.innerHTML = `
  ...
  <div>
    ...
    <dialog class="modal">
      <div class="modal-box bg-white rounded-md m-0 p-3 flex flex-col" style="height:600px; min-width:500px; min-height:400px;">
    ...
    <div class="cb-open-modal-button cursor-pointer absolute -top-0 -left-0 drop-shadow-md hover:drop-shadow-lg ml-2 mt-2 fill-gray-400 hover:fill-gray-500">
