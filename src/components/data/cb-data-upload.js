...
template.innerHTML = `
    ...
    <div class="cb-data-upload mx-auto px-4 sm:w-full lg:w-1/2 bg-white border pb-2 pt-3 rounded-2xl shadow-lg flex-col gap-1 my-2">
    ...
    <label class="w-fit pl-0.5 mb-2 text-sm text-neutral-800 dark:text-neutral-300 font-bold" for="fileInput">Load your File</label>
        ...
        <div class="icon-row flex justify-around mt-2">
            <div class="grayscale-[80%] icon hover:bg-neutral-100 hover:border hover:shadow cursor-not-allowed w-12 h-12 p-2 rounded-full">
            ...
            <div class="grayscale-[80%] icon hover:bg-neutral-100 hover:border-2 hover:shadow cursor-not-allowed w-12 h-12 p-2 rounded-full">
