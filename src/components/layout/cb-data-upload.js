...
const svgGoogleDrive = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87.3 78">
...
const svgExcel = `<svg xmlns:x="http://ns.adobe.com/Extensibility/1.0/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 2080 2080" style="enable-background:new 0 0 2080 2080;" xml:space="preserve">
                    <style type="text/css">
                        .st0{fill:#FFFFFF;}
                        .st1{fill:#217346;}
...
class CBDataUpload extends HTMLElement {
  ...
  handleFileUpload(event) {
    ...
    //   axios
    //     .post("http://localhost:8000/data/upload/", formData, {
    //       headers: {
    //         "Content-Type": "multipart/form-data",
    //         "X-CSRFToken": "lEnzPpmbKwEbKnpiT19hSsA6MhEfzDmM",
    //         'Authorization': `Bearer lEnzPpmbKwEbKnpiT19hSsA6MhEfzDmM`,
    //       },
    //     })
    //     .then((response) => {
